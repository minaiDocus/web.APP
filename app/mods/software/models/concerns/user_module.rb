module SoftwareMod::UserModule
  ...
  class_methods do
    def filter_by_software(software=nil)
      response = all
    ...
    def using_by_software(software)
      if software.in? SoftwareMod::Configuration::SOFTWARES
        all.joins(software.to_sym).where("#{SoftwareMod::Configuration.softwares_table_name[software.to_sym]}".to_sym => { is_used: true } )
      end
    end
  end
