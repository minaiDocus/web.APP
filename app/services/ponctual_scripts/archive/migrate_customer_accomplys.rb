class PonctualScripts::MigrateCustomerAccomplys < PonctualScripts::PonctualScript
  def self.execute
    #------------------- VERY IMPORTANT : ------------------
  ...
  def execute
    organization = Organization.find_by_code 'SEL'
    customers    = User.where(code: ['ACC%0424', 'ACC%0419', 'ACC%0333'])
  ...
  def backup
    organization = { 'SEL%0424' => 1, 'SEL%0419' => 1, 'SEL%0333' => 1 }
    customers    = User.where(code: ['SEL%0424', 'SEL%0419', 'SEL%0333'])
