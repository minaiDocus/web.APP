...
class Admin::Supports::MainController < BackController
  ...
  def get_operations
    ...
    @operations = @operations.where(is_coming: params[:is_coming])        if params[:is_coming].present?
    @operations = @operations.where(is_locked: params[:is_locked])        if params[:is_locked].present?
