...
class Exercises::MainController < OrganizationController
  ...
  # GET /organizations/:organization_id/customers/:customer_id/exercises/new
  def new
    @exercise = Exercise.new
  end

  # POST /organizations/:organization_id/customers/:customer_id/exercises
  def create
  ...
  # GET /organizations/:organization_id/customers/:customer_id/exercises/edit
  def edit; end

  # PUT /organizations/:organization_id/customers/:customer_id/exercises/:id
  def update
  ...
  # DELETE /organizations/:organization_id/customers/:customer_id/exercises/:id
  def destroy
    @exercise.destroy
