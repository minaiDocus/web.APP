...
class Organizations::RetrievedDocumentsController < RetrieverController
  ...
  def validate
    ...
    redirect_to select_organization_customer_retrieved_documents_path(@organization, @customer, document_contains: params[:document_contains])
  end
