...
jQuery(function () {
  ...
  AppListenTo('select_for_orders', (e)=>{ order.select_for_orders(); });
  AppListenTo('add_or_edit_paper_set_order', (e)=>{ order.add_or_edit_paper_set_order(e.detail.url); });
  ...
  AppListenTo('update_table_price', (e)=>{ order.update_table_price(); });
  AppListenTo('update_table_casing_counts', (e)=>{ order.update_table_casing_counts(e.detail.index); });

  AppListenTo('order_multiple_paper_set', (e)=>{ order.order_multiple_paper_set(e.detail.url, e.detail.data); });
