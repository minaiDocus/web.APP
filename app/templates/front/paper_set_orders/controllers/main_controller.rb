...
class PaperSetOrders::MainController < OrganizationController
  ...
  # GET /organizations/:organization_id/paper_set_orders/new?template=
  def new
  ...
  # POST /organizations/:organization_id/paper_set_orders/create
  def create
    ...
    if Order::PaperSet.new(@customer, @order).execute
      ...
      redirect_to organization_paper_set_orders_path(@organization)
    else
      render :new
    end
  end

  # GET /organizations/:organization_id/paper_set_orders/:id
  def edit
  ...
  # PUT /organizations/:organization_id/paper_set_orders/:id
  def update
  ...
  # DELETE /organizations/:organization_id/paper_set_orders/:id
  def destroy
  ...
  def order_multiple
    if params[:customer_ids].present?
      ...
      redirect_to select_for_orders_organization_paper_set_orders_path(@organization)
    end
  end
