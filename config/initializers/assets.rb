...
Rails.application.config.assets.precompile += %w( front/main.css front/main_axelium.css front/organization_lefter.css front/organization_lefter_axelium.css back/main.css front/organization_lefter_dk_partners.css front/main_dk_partners.css )
