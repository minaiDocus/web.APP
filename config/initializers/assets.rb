...
Rails.application.config.assets.precompile += %w( ppp/base.css ppp/kits.css ppp/paper_process.css ppp/receipts.css ppp/returns.css ppp/scans.css account/reporting.css account/profiles.css account/mcf_settings.css account/organization/retrievers.css account/addresses.css account/organizations.css account/group_organizations.css account/ibiza.css account/paper_processes.css
...
Rails.application.config.assets.precompile += %w( ppp/paper_process.js account/accounting_plans.js inner.js welcome.js account/ftps.js account/sftps.js account/reporting.js account/profile.js account/addresses.js account/organizations.js account/group_organizations.js account/software_users.js
