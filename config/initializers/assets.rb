...
Rails.application.config.assets.precompile += %w( paper_process.css account/reporting.css account/profiles.css account/mcf_settings.css account/organization/retrievers.css account/addresses.css account/organizations.css account/group_organizations.css account/ibiza.css account/paper_processes.css
