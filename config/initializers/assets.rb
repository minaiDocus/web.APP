...
Rails.application.config.assets.precompile += %w( front/main.css front/main_axelium.css front/organization_lefter.css front/organization_lefter_axelium.css back/main.css )
